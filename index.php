...
<!-- ****************************  HOME PAGE   ******************************************* -->
    <section id="homepage" class="drivepage">    
    
	<div class="static-header register-version light clearfix">

        <div class="text-heading">
            <h1 class="animated highlight2" data-animation="bounceInDown" data-delay="0">Laundry day?! &mdash; <span class="highlight shadow">We've got you covered</span></h1>
            <p class="animated shadow" data-animation="fadeInDown" data-delay="500">first online subscription laundry service in Ibadan!</p>
        </div>
		
		<div class="container">
			<div class="signup-wrapper animated" data-animation="bounceInUp" data-delay="0">
				<div class="row">
		...
		<div class="container">
            <div class="section-header animated" data-animation="fadeInDown">
            ...
            <div class="section-content row">
                ...
                <div class="col-sm-6">
                    <div class="package-column animated" data-animation="flipInY">
                ...
                <div class="col-sm-2">
                    <div class="package-column animated" data-animation="flipInY" data-delay="500">
...
<!-- ****************************  FEATURES PAGE   ******************************************* -->
<section id="featurespage" class="section inverted drivepage">
        <div class="container">
            <div class="section-content">
                <div id="featuredTab">
                    ...
                    <div class="tab-content animated" data-animation="fadeInLeft">
                      <div class="tab-pane in active" id="home"><img src="assets/img/features/rich_features_1.png" class="img-responsive animated" data-animation="fadeInLeft" alt="macbook" /></div>
                      <div class="tab-pane" id="profile"><img src="assets/img/features/rich_features_2.png" class="img-responsive animated" data-animation="fadeInLeft" alt="macbook" /></div>
                      <div class="tab-pane" id="messages"><img src="assets/img/features/rich_features_3.png" class="img-responsive animated" data-animation="fadeInLeft" alt="macbook" /></div>
                    </div>
                </div>
            </div>
        </div>

        <div id="features-list" class="section dark">
        <div class="container animated" data-animation="fadeInDown">
...
<!-- ****************************  PRODUCT, PRICES AND AWARDS PAGE   ******************************************* -->
<section id="productpage" class="section dark drivepage">
        <div class="container">
            <div class="section-header animated" data-animation="fadeInDown">
                <h2>PRODUCT <span class="highlight">PACKAGES</span></h2>
                <div class="sub-heading">
...
<!-- ****************************  END OF PRODUCT, PRICES AND AWARDS PAGE   ******************************************* -->
...
<!-- ****************************  FEEDBACK PAGE   ******************************************* -->
<section id="feedbackpage" class="section light drivepage">
        <div class="container">
            <div class="section-header animated" data-animation="fadeInDown">
            ...
            <div class="section-content">
                ...
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="flexslider testimonials-slider center animated" data-animation="fadeInTop">  
                        <ul class="slides">
                            <li>
    ...
    <div id="feedback-controls" class="section light">
        <div class="container">
...
<!-- ****************************  TEAM PAGE   ******************************************* -->
<section id="teampage" class="section dark drivepage">
        <div class="container">
            <div class="section-header animated" data-animation="fadeInDown">
            ...
            <div class="section-content row">
                        <div class="member col-md-3 col-sm-3 col-xs-6 animated" data-animation="fadeInDown">
                        ...
                        <div class="member col-md-3 col-sm-3 col-xs-6 animated" data-animation="fadeInDown" data-delay="250">
                            <div class="thumb-wrapper">
                                <div class="overlay img-circle"></div>
                                <div class="socials">
                                    <a href="#"><span class="icon icon-socialmedia-08"></span></a><a href="#"><span class="icon icon-socialmedia-07"></span></a><a href="#"><span class="icon icon-socialmedia-05"></span></a><a href="#"><span class="icon icon-socialmedia-09"></span></a>
                        ...
                        <div class="member col-md-3 col-sm-3 col-xs-6 animated" data-animation="fadeInDown" data-delay="500">
                            <div class="thumb-wrapper">
                                <div class="overlay img-circle"></div>
                                <div class="socials">
                                    <a href="#"><span class="icon icon-socialmedia-08"></span></a><a href="#"><span class="icon icon-socialmedia-07"></span></a><a href="#"><span class="icon icon-socialmedia-05"></span></a><a href="#"><span class="icon icon-socialmedia-09"></span></a>
                        ...
                        <div class="member col-md-3 col-sm-3 col-xs-6 animated" data-animation="fadeInDown" data-delay="750">
                            <div class="thumb-wrapper">
                                <div class="overlay img-circle"></div>
                                <div class="socials">
                                    <a href="#"><span class="icon icon-socialmedia-08"></span></a><a href="#"><span class="icon icon-socialmedia-07"></span></a><a href="#"><span class="icon icon-socialmedia-05"></span></a><a href="#"><span class="icon icon-socialmedia-09"></span></a>
        ...
        <div class="container">
            <ul class="list-inline logos">
                <li><img class="animated" data-animation="fadeInUp" data-delay="0" src="assets/img/logos/logo-1.png" alt="mashable" /></li>
                <li><img class="animated" data-animation="fadeInUp" data-delay="200" src="assets/img/logos/logo-2.png" alt="tnw" /></li>
                <li><img class="animated" data-animation="fadeInUp" data-delay="400" src="assets/img/logos/logo-3.png" alt="virgin" /></li>
                <li><img class="animated" data-animation="fadeInUp" data-delay="600" src="assets/img/logos/logo-4.png" alt="microsoft" /></li>
                <li><img class="animated" data-animation="fadeInUp" data-delay="800" src="assets/img/logos/logo-5.png" alt="forbes" /></li>
            </ul>
        </div>
    </div>
    </section>
...
<!-- ****************************  CONTACT, GUARANTEE PAGE   ******************************************* -->
<section id="guaranteepage" class="section light drivepage">
        <div class="container">
            <div class="section-content row">                
...
<!-- ****************************  ABOUT PAGE   ******************************************* -->
    <section id="aboutpage" class="section dark drivepage">
        <div class="container">
                ...
                <div class="col-sm-3">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            ...
                            <a href="mailto:mywashman@gmail.com" style="color:#ffffff">mywashman@gmail.com</a>
                        </li>
                        <li>
